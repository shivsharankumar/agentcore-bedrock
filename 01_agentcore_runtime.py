...
def agent_invocation(payload, context):
    ...
    print("Received payload:", payload)#payload is used topass information such as prompt, system prompt, etc.
    #context is used to pass information such as session id, user id, etc.
    ...
    # Return the answer
    return {"result": result['messages'][-1].content}agentcore invoke '{"prompt": "Which country am I talking about?"}'
